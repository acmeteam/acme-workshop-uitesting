...
class ListViewController: UITableViewController, UITextFieldDelegate, ListColorCellDelegate, ListDocumentDelegate, ListPresenterDelegate {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(ListViewController.handleDocumentStateChangedNotification(_:)), name: UIDocumentStateChangedNotification, object: document)
    }
