...
public class AppConfiguration {
    ...
    public struct UserActivity {
        ...
        public static let editing = "rs.pstech.testexample.Lister.editing"
        
        // The watch user activity is used to continue activities started on the watch on other devices.
        public static let watch = "rs.pstech.testexample.Lister.watch"
    ...
    */
    ...
    public class var listerUTI: String {
        return "rs.pstech.testexample.Lister"
    }
